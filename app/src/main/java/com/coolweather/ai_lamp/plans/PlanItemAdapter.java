package com.coolweather.ai_lamp.plans;
...
public class PlanItemAdapter extends RecyclerView.Adapter<PlanItemAdapter.PlanItemViewHolder> {
    ...
    static class PlanItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public PlanItemViewHolder( View itemView, Context context) {
            super(itemView);
    ...
    @Override
    public void onBindViewHolder( final PlanItemViewHolder planItemViewHolder, int i) {
